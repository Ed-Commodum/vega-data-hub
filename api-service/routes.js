...
const routes = (app, pgPool) => {
    ...
    // Status codes we want to respond with:
    //  - 200: Success
    //  - 400: Bad request
    //  - 404: Not found (Maybe? Or just return empty result...)
    ...
    */
    ...
    app.get('/decimals', async (req, res) => {
        ...
        switch (true) {
            ...
            case (marketId != undefined): {
                ...
                const marketRes = await asyncQuery('market-decimals', ...marketQueries.getDecimals(marketId), pgPool).catch((err) => {
    ...
    // CALL refresh_continuous_aggregate('stake_linking_diffs_1h', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('stake_linking_diffs_5m', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('taker_data_5m', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('taker_data_1h', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('taker_data_1d', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('candles_5m', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('candles_1h', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('candles_1d', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('fees_earned_5m', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('fees_paid_5m', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('infra_fees_by_asset_5m', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('market_data_1d', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('market_data_1h', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('market_data_5m', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('open_interest_1d', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('open_interest_1h', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('open_interest_5m', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('party_data_1d', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('party_data_1h', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('party_data_5m', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('pnl_deltas_5m', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('pnl_deltas_1h', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('stake_linking_diffs_1d', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('bridge_diffs_5m', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('bridge_diffs_1h', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('bridge_diffs_1d', NULL, 1693312358493531898); CALL refresh_continuous_aggregate('infra_fees_by_market_5m', NULL, 1693312358493531898);
